// ARS SPRINT V26.4 · live start/finish validation · 2026-08-30
const DB_KEY='ARS_SPRINT_10_0_DB';
const LEGACY_KEYS=['ARS_SPRINT_8_1_DB','ARS_SPRINT_8_0_DB','ARS_SPRINT_7_4_DB','ARS_SPRINT_7_3_DB'];
const state={db:{version:'26.4',athletes:[],history:[]},videoUrl:null,videoFile:null,fps:null,start:null,finish:null,lastFrameMeta:null,rvfcId:null,series:{active:false,total:0,current:0,attempts:[]},gates:{},track:{startX:.12,finishX:.88,torso:null,direction:null,drag:null,auto:false,lastDetect:0},calibration:{target:5,estimated:null,quality:'No calibrado',saved:false,referenceWidthM:0.21},photoFinish:{url:null},vision:{selectedGate:5,positions:{},proposals:{},frameImage:null,accepted:false,validatedGates:{},manualGates:{}}};
...
if(x){state.db={version:'26.4',athletes:Array.isArray(x.athletes)?x.athletes:[],history:Array.isArray(x.history)?x.history:[],gates:x.gates&&typeof x.gates==='object'?x.gates:{}};save()}
